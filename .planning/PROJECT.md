...
- [x] AI Agent 层：Pydantic AI + pydantic-deepagents，AG-UI 端点 — validated in Phase 07.1: official AG-UI deferred approval path, adapter delegation, and approval resume flow.
- [x] Packaging buildability：Windows/macOS/Linux native CI artifacts use installer-only uploads plus non-secret manifests — validated in Phase 10.1: macOS DMG and Linux AppImage/deb buildability workflows with hosted/local artifact evidence.

### Active

- [ ] 桌面端：Tauri 2 + React + Vite + Tailwind，CopilotKit 聊天 UI + AG-UI 协议
- [ ] 桌面端：终端面板（Rust portable-pty + xterm.js）
- [ ] 桌面端：代码 Diff 视图（@git-diff-view/react）
- [ ] 桌面端：Computer Use 能力
...
---
*Last updated: 2026-07-14 after Phase 10.1 completion*
